---
title: Stel beleid op voor een verantwoorde inzet van algoritmes binnen de organisatie - Algoritmekader 2.2
...
scraped_at: 2025-06-12T10:32:51.222063
---

# Stel beleid op voor een verantwoorde inzet van algoritmes binnen de organisatie - Algoritmekader 2.2

Source: https://minbzk.github.io/Algoritmekader/voldoen-aan-wetten-en-regels/maatregelen/0-org-02-beleid-opstellen-inzet-algoritmes/index.html
...
[]( "Vereiste ID")org-02[](../../../levenscyclus/ "Levencyclus")[Organisatieverantwoordelijkheden](../../../levenscyclus/organisatieverantwoordelijkheden/)[](../../../rollen/ "Rollen")[Beleid en advies](../../../rollen/beleid-en-advies/)[](../../../onderwerpen/ "Onderwerp")[Governance](../../../onderwerpen/governance/)[](../../../onderwerpen/ "Onderwerp")[Transparantie](../../../onderwerpen/transparantie/)
...
Een duidelijk beleid over de inzet van algoritmes helpt organisaties te voldoen aan de vereisten voor het verantwoord gebruik ervan. Hierin worden zaken beschreven als:
  ...
  * Het beschrijven van de stappen die moeten worden gezet om algoritmes op een verantwoorde wijze in te gaan zetten. Dit is afhankelijk en verschilt per [type algoritme en de bijbehorende risicoclassificatie](../2-owp-05-soort-algoritme/).
  * Het beschrijven van welke hulpmiddelen in welke gevallen moeten worden ingezet om te voldoen aan de vereisten die gelden voor algoritmes. Hierbij kan worden gedacht aan:
    ...
    * Een [Impact Assessment Mensenrechten en Algoritmes](../../hulpmiddelen/IAMA/).
    * Een [Data Protection Impact Assessment](../../hulpmiddelen/DPIA/).
    * Het hanteren van [inkoopvoorwaarden](../../hulpmiddelen/inkoopvoorwaarden/).
    * Het uitvoeren van een [biasanalyse](../5-ver-03-biasanalyse/).
  * Hoe burgers worden geïnformeerd over de inzet van algoritmes door de organisatie (communicatiestrategie) en welke kanalen hiervoor kunnen worden gebruikt. Hierbij kan worden gedacht aan:
    ...
    * Het [Algoritmeregister](../../hulpmiddelen/algoritmeregister/) voor het publiceren van hoog risico AI-systemen of impactvolle algoritmes.
    * Een algemene pagina op de website met informatie over de inzet van algoritmes.
    * Het [verwerkingsregister](../6-imp-07-vermelding-in-verwerkingsregister/).
    ...
    * In welke gevallen een [(openbaar) besluit](../6-imp-08-politiek-bestuurlijk-besluit/) wordt genomen door het bestuur over de inzet van een algoritme.
  * Of algoritmes zelf worden ontwikkeld, of dat algoritmes of systemen worden [ingekocht](../../../onderwerpen/publieke-inkoop/). Dit vraagt om een andere governancestructuur en aanpak.
  ...
  * Er is beschreven welke stappen worden gezetten in het geval dat er incidenten ontstaan rondom de inzet van algoritmes, denk hierbij aan een [discriminatieprotocol](../0-org-15-discriminatieprotocol/).
...
Handreiking Algoritmen - Gemeente Amsterdam
...
Ethische commissie Gemeente Groningen
